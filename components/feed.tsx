...
export function Feed({ initialReviews = [], limit: propLimit }: FeedProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="sticky top-[64px] z-20 pt-0 pb-2 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 max-w-full">
        <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center sm:justify-between gap-2 border rounded-lg p-2 sm:p-3 bg-background shadow-sm">
          <div className="flex flex-wrap items-center justify-between gap-1 sm:gap-2 w-full">
            ...
            {filtersApplied && (
              <div className="flex flex-wrap gap-1.5 mt-1 sm:mt-0 w-full">
                {filterRating !== "all" && (
                  <Badge 
                    variant="secondary" 
