  ...
  return (
    <Card className="mb-4 overflow-hidden hover:shadow-md transition-shadow max-w-full">
      ...
      <CardContent className="pb-3">
        <div className="flex flex-col sm:flex-row gap-6 mb-6 max-w-full">
          {/* Movie Poster - Responsive size for different screens */}
          <Link href={`/details/${review.movie}`} className="shrink-0 mx-auto sm:mx-0">
            <div className="relative h-[320px] w-[213px] md:h-[280px] md:w-[186px] overflow-hidden rounded-md shadow-md hover:shadow-lg transition-shadow">
              {review.moviePoster ? (
                <Image
                  ...
                  sizes="(max-width: 768px) 213px, 186px"
                  loading="lazy"
                  placeholder="blur"
          ...
          <div className="flex-1 flex flex-col min-w-0">
            <Link 
              ...
              className="font-semibold text-xl hover:underline text-primary break-words"
            >
              {review.movieTitle}
            </Link>
            <p className="mt-3 text-pretty flex-grow break-words">{review.content}</p>
          </div>
        </div>
